...
class ParamsContainer implements \IteratorAggregate
{
    ...
    public function filterArray($key, $default = [], $filter = FILTER_DEFAULT, $options = [])
    {
        if (!is_array($options)) {
            $options = [
                'flags' => $options
    ...
    protected function filterVar($key, $default, $filter, $options, $forceArray, $options = [])
    {
